...
var jwt_utils_1 = __importDefault(require("../utils/jwt.utils"));
...
function createAccessToken(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            accessToken = jwt_utils_1.default(__assign(__assign({}, user), { session: session._id }), { expiresIn: config_1.default.get("accessTokenTtl") });
